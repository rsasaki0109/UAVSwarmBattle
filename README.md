...
| | |
|---|---|
| <img src="docs/images/swarm_crossing_rvo_vs_orca.gif" width="410"><br><sub>**RVO's reciprocal dance vs ORCA's glide** — same crossing, RVO's tracks kink, ORCA's stay smooth.</sub> | <img src="docs/images/compare_rrt_vs_rrt_star.gif" width="410"><br><sub>**RRT vs RRT\*** — the "optimal" path drives straight into the moving obstacle.</sub> |
| <img src="docs/images/compare_gpu_mppi_vs_mpc_3d.gif" width="410"><br><sub>**GPU-MPPI vs MPC in 3-D**, with sampled rollouts visualised.</sub> | <img src="docs/images/demo_airsim_multi.gif" width="410"><br><sub>**AirSim** photorealistic multi-drone backend.</sub> |
