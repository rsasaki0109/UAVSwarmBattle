...
def _simulate(n, seed, max_steps=320, replan_period=0.2):
...
def main():
    ...
    traj, goals = _simulate(args.n, args.seed, replan_period=args.replan_period)
    ...
    title = ax.set_title("3-D antipodal swarm — APF, full 3-D avoidance",
                         color="#e6edf3", fontsize=14, fontweight="bold", pad=6)
